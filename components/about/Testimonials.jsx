      ...
      <div className="themesflat-container">
        <div className="row">
          <div className="col-md-5 testimonial-item1">
            ...
            <h2>
  Loved by Innovators Everywhere <span className="animation-text">Discover Their Journeys</span>
</h2>

<p>
  Experience the magic of creativity redefined. Artists, small business owners, and dreamers across the globe are using our AI-driven platform to design unique merchandise, gifts, and décor that stand out. Explore how they’ve turned their ideas into reality!
</p>
