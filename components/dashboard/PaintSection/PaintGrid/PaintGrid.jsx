...
const Tab2Grid = ({ images, handleImageClick, selectionType }) => {
  ...
  return (
    <>
      <Row style={{ marginTop: "3rem" }} className={`${selectionType === "bulkSelection" ? styles.selectedBulk : ""}`}>
        {!images ? (
          <h1>No Image</h1>
        ) : (
            ...
            <Col key={index} xs={12} sm={6} md={4} lg={3} className={`mb-4`}>
              <Card
                ...
                className={`${styles.imageCard} ${
                  selectedIndex === (startIndex + index) && selectionType!== "bulkSelection" ? styles.selectedCard : ""
                }`}
              >
                <Card.Img
                  style={{ height: "auto" }}
