    ...
    >
      <div className="header-inner" >
        ...
        <div className="header-right">
           {isAuthenticated ? (
            <Link href="/dashboard" className="tf-button get-start h45 style-blue"  style={{background: "#6844ed"}}>
              <span>Dashboard</span>
            ...
            <>
              ...
              <Link href="/signup" className="tf-button get-start h45 style-blue"  style={{background: "#6844ed"}}>
